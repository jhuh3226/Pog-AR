...
public class FollowPath : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        ...
        //Gizmos.DrawLine(new Vector2(controlPoints[0].position.y, controlPoints[0].position.z), new Vector2(controlPoints[1].position.y, controlPoints[1].position.z));
        //Gizmos.DrawLine(new Vector2(controlPoints[2].position.y, controlPoints[2].position.z), new Vector2(controlPoints[3].position.y, controlPoints[3].position.z));
