...
public class Case6p2MoveArrow : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (this.transform.localPosition.x >= 0.6f)
        {
    ...
    void MoveArrow()
    {
        ...
        endPosition = new Vector3(0.62f, transform.localPosition.y, transform.localPosition.z);
