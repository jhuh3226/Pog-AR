...
public class Case9p2MoveArrow : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (this.transform.localPosition.z >= 0.9f)
        {
    ...
    void MoveArrow()
    {
        ...
        endPosition = new Vector3(transform.localPosition.x, transform.localPosition.y, 0.95f);
